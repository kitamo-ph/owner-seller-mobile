...
assertOrdered(
  recipeService.slice(recipeService.indexOf("export async function loadRecipeIngredientPicker")),
...
console.log(
  "RECIPE STABILIZATION CHECKS PASSED: same-line estimate edits, resolved Step 2/3 rows, exact pinned versions, Required/Optional usage, explicit measured conversions, modal reachability, nested edit actions, evidence cleanup, human unit labels, ready-item visibility, and exact-lot publication",
);
